...
from rl4co.heuristic import LocalSearch_opsa
...
td_init = env.reset(batch_size=[10000]).to(device)      # init batch_size datas by generate_data, return data in td

baseline = LocalSearch_opsa(td_init.clone())
reward = baseline.forward()
print(reward)
