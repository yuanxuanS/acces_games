...
from rl4co.heuristic import LocalSearch1_csp, LocalSearch1_batch_csp

torch.manual_seed(1234)     # 因为每次随机生成的数stochsatic不同，所以必须固定
# RL4CO env based on TorchRL
env = CSPEnv(num_loc=20) 
...
baseline = LocalSearch1_batch_csp(td_init.clone())
tour = baseline.forward()
print(tour)
# done = baseline.check_cover(tour)
# print(done)
# print(done)
# print(td_init["stochastic_cost"][0])

# mean_reward = baseline.forward()
# print(mean_reward)
# print(td_init)
# print(env.dataset().data)       # td: data variables in env
# print(len(env.dataset()))   # init with 0 data
